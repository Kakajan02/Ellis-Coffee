...
<body>
  <script>
    ...
    window.storePhones = ["+99365 103355"];
    window.socials = [
        {
            localeKey: "Instagram",
            mediaText: "@ellis_coffee",
            url: "https://www.instagram.com/ellis_coffee/",
        },
        {
            localeKey: "Tiktok",
            mediaText: "@ellis_coffee",
            url: "https://www.tiktok.com/@ellis_coffee",
        },
    ];
    window.storeAddress = {
      en: "Ashgabat city, Moskovskiy cafe Hyundai house 'ELLIS' 3",
      tm: "Aşgabat şäheri  Moskowiskiy kofe Hyundai jaý “ELLIS” 3",
      ru: "г. Ашхабад  кафе «Московский» Hyundai house 'ELLIS' 3",
      tr: "Aşkabat şehri Moskovskiy kafe Hyundai evi 'ELLIS' 3",
